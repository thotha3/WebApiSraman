...
import pojo.com.upgrade.BorrowerResumptionInfo;
import pojo.com.upgrade.LoanAppResumptionInfo;
...
public class TestCases {
    ...
    public void positiveResponseTestCase() {
        RestAssured.baseURI = "https://credapi.credify.tech/api/brfunnelorch/v2";
        ...
        BorrowerResumptionInfo borrowerInfo = response.as(BorrowerResumptionInfo.class, ObjectMapperType.JACKSON_2);
